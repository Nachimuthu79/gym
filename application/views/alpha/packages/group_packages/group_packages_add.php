          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Group Class Package <small>	</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form" action="" method="post">
                ...
                <div class="form-group">
                 ...
                 foreach($group_class_types as $id=>$name)
                 {
					 ?>
					 
					 	<div class="icheck-primary d-inline">
						<input type="checkbox"   id="allow_<?php echo $id; ?>" value="<?php echo $id; ?>" name="classes[]">
