             ...
             <div class="card-body">
				<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" value="<?php  echo $staff_details['name']; ?>" id="name" placeholder="Enter Name">
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email"  readonly class="form-control" value="<?php  echo $staff_details['username']; ?>"   id="email" placeholder="Enter Email">
                  </div>
                  </div>
