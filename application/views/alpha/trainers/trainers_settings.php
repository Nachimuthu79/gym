             ...
             <div class="card-body">
				<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control" value="<?php  echo $trainer_details['name']; ?>" id="name" placeholder="Enter Name">
                  </div>
                  </div>
                  
                    <div class="col-md-6">                  
                  <div class="form-group">
                    <label for="email">Trainer Username</label>
                    <input type="email"  readonly class="form-control" value="<?php  echo $trainer_details['username']; ?>"   id="email" placeholder="Enter Email">
                  </div>
                  </div>
