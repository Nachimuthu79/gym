          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                  ...
                  <li class="nav-item">
                    <a class="nav-link "  href="<?php echo site_url('trainers/edit/'.$trainer_details['trainer_id']); ?>"  id="custom-tabs-one-home-tab"  aria-selected="true">Details</a>
                  </li>

                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url('trainers/edit/'.$trainer_details['trainer_id']); ?>"id="custom-tabs-one-home-tab" >Settings</a>
                  </li>
                  <li class="nav-item">
...
<!--                              --><?php // $document_type = $document_name = '';
//                              if(!empty($documents)){
                         ...
                         <div class="col-md-3 append_tag">
                             <div class="append_tag" id="document_tag">
                                 <?php foreach($documents as $document) { ?>
                                     <a href="<?php echo base_url('images/document/'.$trainer_details['user_id'].'/'.$document['document_url']);?>"><?php echo $document['document_url'];?></a><a href="<?php echo site_url('trainers/delete_documents/'.$trainer_details['trainer_id'].'/'.$document['id'])?>" onclick="return confirm('Are you sure you want to delete this document?');"><span style="color:red;padding-left:22px;title:remove"><i class="nav-icon fas fa-times"></i></span></span></a><br><br>
                                 <?php } ?>
