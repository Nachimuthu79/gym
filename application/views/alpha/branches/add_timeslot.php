          ...
          <div class="col-md-12">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group date" id="timepicker" data-target-input="nearest">
                      <input type="text"  id="start_time" name="start_time" class="form-control datetimepicker-input" data-target="#timepicker"/>
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group date" id="timepicker1" data-target-input="nearest">
                      <input type="text"  id="end_time" name="end_time" class="form-control datetimepicker-input" data-target="#timepicker1"/>
                   ...
                   <div class="col-md-3">                  
                    ...
                    <label for="status">Status</label> <br>
                       <input type="checkbox" checked  name="status" value="1"  data-bootstrap-switch data-off-color="danger" data-on-color="success" data-off-text="Deactive" data-on-text="Active" >
            ...
            <!-- /.card -->
              ...
              <div class="card-footer text-right">
                  <button type="submit" class="btn btn-primary ripple">Add Timeslot</button>
                </div>
              </form>
